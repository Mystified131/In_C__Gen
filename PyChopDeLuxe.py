...
for reps in range(1):
    ...
    for subdir, dirs, files in os.walk('C:\\Users\\mysti\\Coding\\In_C_Gen\\One_Shot_Bucket'):
        for file in files:
    ...
    for y in range(trlen):
        ...
        try:
            ...
            oufil = "C:\\Users\\mysti\\Coding\\\In_C_Gen\\One_Shot_Bucket\\In_C_Inst_Chopt_" + trnam[y] + "_" + str(tim) + ".wav"
