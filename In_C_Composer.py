...
for voc in range(totvoxlen):
    ...
    for pgen in range(pattlen):
        ...
        print("Using voice number: ", str(voc))
        ...
        if phrlen > trklen:
            ...
            ostr = 'C:\\Users\\mysti\\Coding\\In_C_Gen\\In_C_VoxSegment_' + str(voc) +  ".wav"
...
otstr = 'C:\\Users\\mysti\\Coding\\In_C_Gen\\In_C_MixSegment_' + str(tim) +  ".wav"
